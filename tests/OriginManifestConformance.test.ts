...
> = {
  ...
  P18: ["GLOBAL_OFFENSIVE_PRESSURE|GLOBAL|ORIGIN_PERCENT|ADD_PERCENT|BASIS_POINTS|10000|SOURCE_INSIDE_FIELD:FORT:SELF_OR_FIXED_TEAMMATE"],
  ...
  P24: ["FFY_EVENT_YIELD|FFY:ALL|ORIGIN_PERCENT|ADD_PERCENT|BASIS_POINTS|2000|EVENT_INSIDE_FIELD:FORT:SELF"],
  P25: [
  ...
  P31: [
    ...
    "STRUCTURE_FAST_REPAIR_RADIUS|STRUCTURE:PORT|CONTEXTUAL_SCALAR|MULTIPLY|BASIS_POINTS|20000|TARGET_UNIT_IS:WARSHIP",
  ...
  P34: [
    ...
    "STRUCTURE_REPAIR_RADIUS|STRUCTURE:FACTORY|CONTEXTUAL_SCALAR|MULTIPLY|BASIS_POINTS|15000|STRUCTURE_ACQUISITION_PATH_IS:CAPTURE_TRANSFER&TARGET_UNIT_IS:TANK",
    ...
    "STRUCTURE_REPAIR_RADIUS|STRUCTURE:FACTORY|CONTEXTUAL_SCALAR|MULTIPLY|BASIS_POINTS|15000|STRUCTURE_ACQUISITION_PATH_IS:CAPTURE_TRANSFER&TARGET_UNIT_IS:HEAVY_ARTILLERY",
  ],
  ...
  N11: ["FFY_EVENT_YIELD|FFY:ALL|TERMINAL|HARD_ZERO|NONE||EVENT_INSIDE_FIELD:SAM_LAUNCHER:SELF"],
