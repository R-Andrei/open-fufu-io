...
| **O50 — Lucky Star** | **P54** (same-quota eight-point star-shaped Initial Territory) | **10** | Pure opening-geometry Origin: a much longer starting neutral contact surface without extra starting cells, Population, or capture-speed stats. |
