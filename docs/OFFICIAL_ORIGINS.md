...
| **O22 — The Weak Die First** | **P19** (+5% offense per current active contacted faction, including Minor Factions) · **P03** (ignore enemy Fort defensive-pressure bonus) · **P15** (+33% Highland offense) · **N01** (-20% City Growth) · **N04** (-50% Mountain FFY) | **19 / -8** | Predatory multi-contact aggression that ignores Fort pressure and favors Highlands. |
...
| **O24 — The Devil of the Rhine** | **P43** (Heavy Artillery replaces Tanks) · **P15** (+33% Highland offense) · **P19** (+5% offense per current active contacted faction, including Minor Factions) · **N12** (cannot build Warships) · **N01** (-20% City Growth) | **20 / -10** | Continental Heavy-Artillery breakthrough warfare that escalates with multiple contacts. |
...
| **O07 — The Conman** | **P30** (fast 3×-piracy Warships; no naval gunfire) · **P06** (+25% Trade Ship speed) · **P31** (2× Port repair radius / 1.5× repair rate for Warships) · **N13** (half Transport Population dies on landing) | **17 / -7** | Piracy/trade economy whose Warships raid merchants rather than fight battle fleets. |
| **O05 — The Country Mouse and the City Mouse** | **P37** (+250 FFY embarkation; successful landing grants L1 Fort) · **P32** (Port-only 500-HP armored Transports) · **P12** (+25% Transport speed) · **N12** (cannot build Warships) · **N01** (-20% City Growth) | **19 / -10** | Armored, fast, self-fortifying amphibious invasion without conventional Warships. |
...
| **O46 — Nobel Prize** | **P19** (+5% offense per current active contacted faction, including Minor Factions) · **P44** (Radioactive Munitions) · **N13** (half Transport Population dies on landing) | **17 / -7** | Multi-contact aggression plus radioactive munitions; poor amphibious projection. |
