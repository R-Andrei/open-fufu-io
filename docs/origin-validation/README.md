...
The blocker review is complete. Every mechanic-definition blocker discovered by the audit was routed to its canonical owner rather than solved inside validation metadata. The #32 Spawn blockers, #45 admission blockers, #46 strategic launcher/projectile/charge/blast blockers, and #49 Factory/Train blockers are now resolved by their canonical contracts; remaining unresolved closure routes are #43, #44, #47, #48, #50, and #51.
