...
- **P31 — Heart-Under-Blade** — Direct seam: Port two-tier repair service -> Warship repair/operation. Validate the Warship-specific effective broad and fast repair-field/rate projections through the shared two-tier lifecycle, deterministic provider assignment/queueing and non-stacking, health clamping, and continued ordinary Warship operation while repairing. Explicit interactions: P29, P22/P23; negative assertions that P31 does not change fast-service capacity and that P32 Transports receive only ordinary eligible repair.
